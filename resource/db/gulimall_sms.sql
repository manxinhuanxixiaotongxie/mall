...
(
    ...
    `order_sn`         bigint(0) NULL DEFAULT NULL COMMENT '订单号',
    PRIMARY KEY (`id`) USING BTREE
...
(
    `id`            bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
    `coupon_id`     bigint(0) NULL DEFAULT NULL COMMENT '优惠券id',
    `category_id`   bigint(0) NULL DEFAULT NULL COMMENT '产品分类id',
...
VALUES (1, '8:00', '2022-06-09 08:00:00', '2022-06-30 20:00:00', 1, '2022-06-09 17:51:11');
INSERT INTO `sms_seckill_session`
VALUES (2, '10:00', '2022-06-09 10:00:00', '2022-06-30 12:00:00', 1, '2022-06-09 17:51:05');
INSERT INTO `sms_seckill_session`
VALUES (3, '12:00', '2022-06-09 12:00:00', '2022-06-30 14:00:00', 1, '2022-06-09 20:06:43');
...
(
    ...
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '秒杀活动商品关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_seckill_sku_relation
-- ----------------------------
INSERT INTO `sms_seckill_sku_relation`
VALUES (1, NULL, 1, 30, 5499.0000, 10, 1, 0);
INSERT INTO `sms_seckill_sku_relation`
VALUES (3, NULL, 2, 30, 5599.0000, 10, 1, 1);
INSERT INTO `sms_seckill_sku_relation`
VALUES (4, NULL, 3, 45, 2199.0000, 10, 1, 2);
...
(
    `id`           bigint(0) NOT NULL AUTO_INCREMENT COMMENT 'id',
    `sku_id`       bigint(0) NULL DEFAULT NULL COMMENT 'spu_id',
...
(
    ...
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品spu积分设置' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_spu_bounds
-- ----------------------------
INSERT INTO `sms_spu_bounds`
VALUES (1, 14, 0.0000, 0.0000, NULL);
INSERT INTO `sms_spu_bounds`
VALUES (2, 15, 0.0000, 0.0000, NULL);
INSERT INTO `sms_spu_bounds`
VALUES (3, 16, 0.0000, 0.0000, NULL);
INSERT INTO `sms_spu_bounds`
VALUES (4, 17, 0.0000, 0.0000, NULL);
INSERT INTO `sms_spu_bounds`
VALUES (5, 18, 0.0000, 0.0000, NULL);
